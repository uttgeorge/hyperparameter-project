...
CREATE TABLE IF NOT EXISTS DeepLearning_model (
  ...
  `hidden_dropout_ratios` JSON NULL DEFAULT NULL,
  ...
  PRIMARY KEY (DeepLearning_model_id),
...
CREATE TABLE IF NOT EXISTS StackedEnsemble_BestOfFamily_model (
  ...
  PRIMARY KEY (StackedEnsemble_BestOfFamily_model_id),
...
CREATE TABLE IF NOT EXISTS StackedEnsemble_AllModels_model (
  ...
  PRIMARY KEY (StackedEnsemble_AllModels_model_id),
